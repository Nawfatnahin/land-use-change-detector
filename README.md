...
## Note
This application, including UI design, mapping logic and data integration was developed using modern AI-assisted workflows with custom data integration, visualization design and project direction by the author.
